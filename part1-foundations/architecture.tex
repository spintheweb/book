...
\begin{description}
\item[\textbf{Webbase Description Language (\wbdl{})}]: A declarative language for modeling complex portal structures, data relationships, and business logic
\item[\textbf{Web Spinner Runtime}]: A runtime that interprets \wbdl{} specifications and delivers dynamic, role-based content
...
\section{Foundations: Webbase Description Language (\wbdl{})}
...
Key characteristics:
\begin{itemize}
	\item \textbf{Declarative rules in \wbdl{}}: visibility is defined per element and can be inherited.
...
For operational details see \secref{sec:security} in the Web Spinner chapter, and for the formal schema see the \wbdl{} appendix (\cref{app:wbdl-json-schema}).
