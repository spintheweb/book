...
While developing a proof of concept for this dynamic approach, a transformative idea crystallized: use web technologies inside the company to build a web site—an eSite, later termed a \textbf{portal}—whose target audience extended far beyond the general public.
