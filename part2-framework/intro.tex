...
\begin{description}
\item[\textbf{Chapter 5: The WBOL Language}] (Chapter~\ref{chap:wbol}) -- Provides a comprehensive introduction to the Webbase Ontology Language, including its XML Schema (XSD) definitions, element hierarchy, and practical usage patterns.
...
\item[\textbf{Chapter 9: The Web Spinner}] (\cref{chap:web-spinner}) -- Details the runtime engine that processes WBOL specifications and generates dynamic web portals, including its architecture, processing pipeline, and performance characteristics.
