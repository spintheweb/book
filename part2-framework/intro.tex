...
\begin{description}
\item[\textbf{Chapter 5: The WBOL Language}] (\cref{chap:wbol}) -- Provides a comprehensive introduction to the Webbase Ontology Language, including its JSON Schema definitions, element hierarchy, and practical usage patterns.
