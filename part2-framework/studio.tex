% Chapter 10: Spin the Web Studio
...
While the \wbol{} and \wbpl{} languages provide a powerful declarative framework for defining enterprise portals, and the \webspinner{} runtime offers a robust execution layer, the development experience can still be laborious. Without a dedicated toolset, a developer would be forced to:

\begin{itemize}
    \item Write and edit complex \wbol{} files in a standard text editor, without syntax highlighting, validation, or autocompletion.
...
\begin{itemize}
    \item Changes to \wbol{} files are immediately reflected in the persistent portal view
...
\subsection{The WBOL Editor}
A rich text editor with full support for the \wbol{} syntax, featuring:
\begin{itemize}
