...
\begin{itemize}
  ...
  \item \texttt{@@fieldname} — double-\texttt{@} substitution. This can resolve from a query field, a session variable, an application variable shared across sessions, or an HTTP header such as \texttt{@@REQUEST_METHOD}.
