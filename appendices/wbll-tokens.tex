...
\textbf{Example recordset} (fields in order): \texttt{rent}, \texttt{username}, \texttt{city}.

\medskip
\begin{tabularx}{\linewidth}{@{}l l l@{}}
\textbf{rent} & \textbf{username} & \textbf{city} \\
\hline
450.00 & alice & Milan \\
525.00 & bob & Paris \\
400.00 & carol & Berlin \\
...
(2) the field cursor starts at the first field (\texttt{rent});
(3) when currency output like “€ 1{,}234.50” appears, it is the formatted \texttt{rent} of row 1 using the pattern \texttt{€ \#,\#\#0.00}.
}
\end{tcolorbox}
...
\end{tabularx}}
\begin{lstlisting}[style=wbll-appendix, language=HTML]
<input type="text" name="rent" value="450.00" required style="color:red"><input type="text" name="username" value="alice" maxlength="20">
\end{lstlisting}
\end{tcolorbox}
...
\end{tabularx}}
\begin{lstlisting}[style=wbll-appendix, language=HTML]
<input type="hidden" name="rent" value="450.00"><input type="hidden" name="kind" value="area"><input type="hidden" name="id" value="alice">
\end{lstlisting}
\end{tcolorbox}
...
\end{tabularx}}
\begin{lstlisting}[style=wbll-appendix, language=HTML]
<label for="uname">Username:</label><input type="text" name="username" id="uname" value="450.00">
\end{lstlisting}
\end{tcolorbox}
...
\end{tabularx}}
\begin{lstlisting}[style=wbll-appendix, language=HTML]
<input type="password" name="pwd" value="secret"><br><input type="password" name="rent" value="450.00"><br><input type="password" name="username" value="password">
\end{lstlisting}
\end{tcolorbox}
