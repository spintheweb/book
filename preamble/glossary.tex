...
\newglossaryentry{webbase}{
    ...
    sort={webbase},
    plural={webbases},
    description={A complete WBOL-described portal: the full, declarative structure of a portal including areas, pages, contents, datasources, and configuration}
}
...
\newglossaryentry{webbaselet}{
    ...
    sort={webbaselet},
    plural={webbaselets},
    description={A modular fragment of a webbase. A WBOL document rooted at an STWArea that can be imported or integrated into a full webbase}
}

\newglossaryentry{ebranding}{
    name={eBranding},
    sort={ebranding},
    description={The practice of virtualizing all virtualizable aspects of an entity (organization, enterprise, trade, or group) into a single, coherent digital channel. eBranding unifies documentation and action: it presents public and private information, interactive workflows, and system integrations through a role-aware portal that acts as the brand's primary digital harbor. It emphasizes consistency, accessibility, and governance across audiences (public, customers, suppliers, partners, regulators, employees), and favors integration over replacement by orchestrating APIs and existing systems behind a unified experience. eBranding is the philosophy that the Spin the Web Project stewards; the Spin the Web framework is built to realize it}
}

\newglossaryentry{stwproject}{
    name={Spin the Web Project},
    sort={spin the web project},
    description={The organization stewarding the eBranding philosophy and, in service of it, the Spin the Web framework (\wbol, the \webspinner, and the \studio). The Project is first a philosophy; the framework is the means by which that philosophy is realized}
}
